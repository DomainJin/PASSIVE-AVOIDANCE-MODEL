...
smallest_division = total_frames/8
# In thông tin video
...
mask_1 = (heatmap > 0) & (heatmap < smallest_division)          # Tím
mask_2 = (heatmap >= smallest_division) & (heatmap < 2*smallest_division)       # Chàm
mask_3 = (heatmap >= 2*smallest_division) & (heatmap < 3*smallest_division)        # Lam
mask_4 = (heatmap >= 3*smallest_division) & (heatmap < 4*smallest_division)      # Lục
mask_5 = (heatmap >= 4*smallest_division) & (heatmap < 5*smallest_division)     # Vàng
mask_6 = (heatmap >= 5*smallest_division) & (heatmap < 6*smallest_division)     # Cam
mask_7 = (heatmap >= 6*smallest_division) & (heatmap < 7*smallest_division)     # Đỏ nhạt
mask_8 = (heatmap >= 8*smallest_division)                     # Đỏ đậm
...
classified_heatmap[mask_1] = 1      # Tím
classified_heatmap[mask_2] = 2     # Chàm
classified_heatmap[mask_3] = 3     # Lam
classified_heatmap[mask_4] = 4    # Lục
classified_heatmap[mask_5] = 5    # Vàng
classified_heatmap[mask_6] = 6    # Cam
classified_heatmap[mask_7] = 7    # Đỏ nhạt
classified_heatmap[mask_8] = 8    # Đỏ đậm
